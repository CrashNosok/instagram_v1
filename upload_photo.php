...
if (isset($_POST['upload_cam'])) {
    $img = str_replace(' ', '+', $_POST['upload_cam']);
    $img = base64_decode($img);
    $name = date('Y_m_d_H_i_s');
    file_put_contents(__DIR__ . '/static/img/' . $name . '.png', $img);
    echo 'OK';
} else {
    echo 'ERROR';
}
...
// else if (isset($_POST['upload_comp'])) {
...
//     if (!move_uploaded_file($filePath, __DIR__ . '/static/img/' . $name . $format)) {
